...
<cms:template title='Produk Aksesoris' clonable='1' dynamic_folders='1' gallery='1'>
   <cms:editable 
      name='gg_image' 
      label='Image' 
...
<html lang="en" class="no-js">
	...
	<body class="layout-content">
		<div id="ip-container" class="ip-container">
			...
			<!-- main content -->
			<div class="bg-abstract partner services canopy">
			    		...
			    		<div class="container">
			    			<div class="col s12 l9 m9 m-pd">
			    				<div class="img-service left">
			    					<img src="../assets/img/Acc Icon.png" width="200">
			    				</div>
