...
<cms:template title='Produk Kaca' clonable='1' dynamic_folders='1' gallery='1'>
   <cms:editable 
      name='gg_image' 
      label='Image' 
   ...
   <cms:editable 
      ...
      type='textarea'
   />
    <cms:editable name='prods_desc_id' label='Description Indonesia' desc='Enter description of property here' type='richtext' />
	<cms:editable name='prods_desc_en' label='Description English' desc='Enter description of property here' type='richtext' />           
</cms:template>
...
<html lang="en" class="no-js">
	...
	<body class="layout-content">
		<div id="ip-container" class="ip-container">
			...
			<!-- main content -->
			<div class="bg-abstract partner services cladding">
				<div class="intro-products">
			    	<h4>PRODUK-PRODUK PJK</h4>
			    	<div class="row">
			    		<div class="container">
			    			<div class="col s12 l9 m9 m-pd">
			    				<div class="img-service left">
			    					<img src="../assets/img/Kaca Icon.png" width="200">
			    				</div>
			    			...
			    			<div class="col s12 l3 m3 backtocat">
			    				<a href="../product.php">Kembali ke Kategori</a>
			    			</div>
			    		</div>
			    	</div>
							      ...
							      <ul class="gallery">
							         <cms:pages folder=k_folder_name include_subfolders='0' limit='12' paginate='1'>
							            <li class="col s12 l3 m4">
							               <a href="<cms:watermark gg_image with='watermark.png' at='bottom_right' check_exists='0' />" rel="lightbox-<cms:show k_page_foldername/>" <cms:if my_desc>title="<cms:show my_desc/>"</cms:if>>
							                  <img alt="<cms:show k_page_title />" src="<cms:watermark my_thumb_2 with='watermark.png' at='middle' check_exists='0' />"/>
