...
<cms:template title='Produk Alumunium Lembar' clonable='1' dynamic_folders='1' gallery='1'>
   <cms:editable 
      name='gg_image' 
      label='Image' 
...
<html lang="en" class="no-js">
	...
	<body class="layout-content">
		<div id="ip-container" class="ip-container">
			...
			<!-- main content -->
			<div class="bg-abstract partner services plafon">
			    		...
			    		<div class="container">
			    			<div class="col s12 l9 m9 m-pd">
			    				<div class="img-service left">
			    					<img src="../assets/img/Alum Lbr Icon.png" width="200" style="padding-top:60px;">
			    				</div>
			    				<div class="desc-service left white-text">
			    					<h5>Alumunium Lembar</h5>
