...
<cms:template title='Contact Us' >
	<cms:editable name='contact_intro_id' label='Introductory text Indonesia' type='richtext'></cms:editable>
	<cms:editable name='contact_intro_en' label='Introductory text English' type='richtext'></cms:editable>
</cms:template>
			...
			<div class="bg-abstract contacts animations ">
				<div class="intro-products">			    	
			    	<div class="row animatedParent">
			    		<div class="container">
			    			<h4 class="animated bounceInLeft slower"><cms:if my_lang='id'>HUBUNGI KAMI</cms:if><cms:if my_lang='en'>CONTACT US</cms:if></h4>
			    			<div class="col s12 l6 m6 form-contact animated bounceInDown slower">
			    				<cms:if my_lang='id'><cms:show contact_intro_id /></cms:if>
								<cms:if my_lang='en'><cms:show contact_intro_en /></cms:if>	
			    			...
			    			<div class="col s12 l6 m6 icon-contact animated bounceInRight slower">
			    				...
			    				<div>
			    					<h4><cms:if my_lang='id'>WORKSHOP KAMI</cms:if><cms:if my_lang='en'>OUR WORKSHOP</cms:if></h4>
