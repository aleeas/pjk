...
<cms:template title='Service Composite Panel' clonable='1' dynamic_folders='1' gallery='1'>
   <cms:editable 
      name='gg_image' 
      label='Image' 
			    		...
			    		<div class="container">
			    			<div class="col s12 l9 m6 m-pd">
			    				<div class="img-service left">
			    					<img src="../assets/img/Cladding Icon.png" width="200">
			    				</div>
			    				<div class="desc-service left white-text">
			    					<h5>Cladding Alumunium Composite Panel</h5>
