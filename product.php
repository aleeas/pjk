...
<cms:template title='Product' >
	<cms:editable name='prod_desc_id' label='Description Indonesia' desc='Enter description of property here' type='richtext' />
	<cms:editable name='prod_desc_en' label='Description English' desc='Enter description of property here' type='richtext' />
		...
		<div class="bg-abstract products animations">
				<div class="intro-products">
			    	<div class="animatedParent">
			    		<h4 class="animated bounceInLeft slower">
			    			<cms:if my_lang='id'>PRODUK-PRODUK PJK</cms:if>
			    			<cms:if my_lang='en'>PRODUCTS PJK</cms:if>
			    		</h4>
			    	</div>
			    	<div class="row">
			    		<div class="product-container animatedParent">
			    			<div class="col s7 l6 right-align top-text animated bounceInLeft slower">
			    				<cms:if my_lang='id'><cms:show prod_desc_id /></cms:if>
								<cms:if my_lang='en'><cms:show prod_desc_en /></cms:if>
			    			</div>
				...
				<div class="ip-main">
					<div class="row">
						<div class="category-product">
							<h6><cms:if my_lang='id'>Pilih Kategori</cms:if><cms:if my_lang='en'>Choose Category</cms:if></h6>
