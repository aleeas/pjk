			      ...
			      <li>
			        ...
			        <div class="caption center-align">
			          <h5 class="light grey-text text-lighten-3">
			          	<cms:if my_lang='id'>Selamat datang di</cms:if>
			          	<cms:if my_lang='en'>Welcome to</cms:if>
			          </h5>
				...
				<div class="ip-main animations">
					<div class="home-wrapper">
						<div class="animatedParent" data-sequence='500'>
							<h4 class="animated bounceIn slower" data-id='1'>
								<cms:if my_lang='id'>Tentang Kami</cms:if>
								<cms:if my_lang='en'>About Us</cms:if>
							</h4>
						</div>
